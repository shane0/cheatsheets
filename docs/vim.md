...
- vim is an extremely powerful tool for editing text and automation

## record and playback 

1. q then any letter to start recording
1. q to stop recording
1. playback with @(your letter)
 1. use numbers to repeat e.g. 4@f repeats macro f four times
